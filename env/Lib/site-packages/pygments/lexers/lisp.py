...
class RacketLexer(RegexLexer):
    ...
    _builtins = (
        ...
        'blame-add-cars-context', 'blame-add-cdr-context', 'blame-add-context',
        ...
        'call/ec', 'cars', 'cartesian-product', 'cdaaar', 'cdaadr', 'cdaar',
...
class EmacsLispLexer(RegexLexer):
    ...
    builtin_function = {
        ...
        'capitalize-region', 'capitalize-word', 'cars', 'cars-less-than-cars',
        'cars-safe', 'case-table-p', 'category-docstring',
...
class XtlangLexer(RegexLexer):
    ...
    common_functions = (
        ...
        'caddar', 'cadddr', 'caddr', 'cadr', 'cars', 'cdaaar',
    ...
    scheme_functions = (
        ...
        'remainder', 'scheme-report-environment', 'set-cars!', 'set-cdr!',
